 ...
 * @property string running_frequency
 * @property string desired_size
 * @property string shoes_size
 */
class KichijojiGreyDays5KRunRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'running_frequency' => 'ランニング頻度',
            'desired_size' => '試し履き希望シューズ',
            'shoes_size' => 'シューズサイズ',
        ];
    }
}
