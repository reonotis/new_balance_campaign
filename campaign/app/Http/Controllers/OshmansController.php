...
class OshmansController extends Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->checkErrorViewRedirect()) {
            Redirect::route('oshmans.outsidePeriod')->send();
        }
    }
    ...
    public function store(MinatoRunnersBaseRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            Redirect::route('oshmans.complete')->send();
    ...
    private function sendThankYouMail(MinatoRunnersBaseRequest $request)
    {
        ...
        Mail::send('emails.oshmans.thankYouMail', $data, function ($message) {
    ...
    private function sendReportMail(MinatoRunnersBaseRequest $request)
    {
        ...
        Mail::send('emails.oshmans.reportMail', $data, function ($message) {
    ...
    private function checkErrorViewRedirect()
    {
        ...
        if (\Route::currentRouteName() ==  'oshmans.outsidePeriod') {
            return false;
        }
