...
class TryOn2023AutumnController extends Controller
{
    ...
    function __construct()
    {
        ...
        if (Route::currentRouteName() <> 'try-on-2023-autumn.outsidePeriod') {
            if (!$this->commonApplyService->checkApplicationDuration()) {
                Redirect::route('try-on-2023-autumn.outsidePeriod')->send();
            }
        }
    ...
    {
        return view('try_on_2023_autumn.index');
    }
    ...
    {
        return view('try_on_2023_autumn.complete');
    }
    ...
    public function store(TryOnRequest $request)
    {
        ...
        try {
            ...
            return view('try_on_2023_autumn.error', compact('errorMessage'));
        }
    }
    ...
    public function outsidePeriod(): View
    {
        ...
        return view('try_on_2023_autumn.notApplicationPeriod', compact('checkMessage'));
    }
}
