@extends('layouts.kichijoji_grey_days_5k_running')
@section('header')
@endsection
@section('content')
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <form action="{{ route('kichijoji-grey-days-5k-running.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="itemRow">
                        ...
                        <div class="itemRow">
                            <label for="email" class="itemTitle">ランニング頻度</label>
                            <div class="itemContent px-2">
                                <div class="w-full mb-1">
                                    @foreach(App\Consts\KichijojiGrayDays5KRun::RUNNING_FREQUENCY as $running_value => $running_label)
                                        <label class="radio-label">
                                            <input type="radio" class="" name="running_frequency" value="{{ $running_value }}"
                                                @if(old('running_frequency') == $running_value)
                                                    checked="checked"
                                                @endif
                                            >
                                            {{ $running_label }}
                        ...
                        <div class="itemRow">
                            <label for="email" class="itemTitle">試し履き希望シューズ</label>
                            <div class="itemContent px-2">
                                <div class="w-full mb-1">
                                    @foreach(App\Consts\KichijojiGrayDays5KRun::DESIRED_SIZE as $value => $label)
                                        <label class="radio-label">
                                            <input type="radio" class="" name="desired_size" value="{{ $value }}"
                        ...
                        <div class="itemRow">
                            <label for="email" class="itemTitle">シューズサイズ</label>
                            <div class="itemContent px-2">
                                <x-input-select name="shoes_size" class="block mt-1 w-full"
                                         :options="App\Consts\KichijojiGrayDays5KRun::SHOES_SIZE" />
                            </div>
                        </div>
