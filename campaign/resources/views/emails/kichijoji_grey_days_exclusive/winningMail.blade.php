{{ $customerName }} 様<br>
<br>
<img src="{{ asset('img/kichijoji_grey_days_exclusive/unnamed.jpg') }}"><br>
<br>
この度はmyNB会員様向けNew Balance Grey Days 2024 Exclusive Event　(5月16日開催)へのご応募ありがとうございます。<br>
<br>
抽選の結果、ご当選されましたので、<br>
当日のご案内をさせていただきます。<br>
<br>
