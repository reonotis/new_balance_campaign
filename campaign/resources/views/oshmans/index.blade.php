                ...
                <div class="form-area">
                    <div class="event-explanation">
                        <div class="event-explanation-row">
                            <div class="event-explanation-title">スペシャルランニングイベント</div>
                            <div class="event-explanation-title"> feat. 志村美希</div>
                        </div>
                        <div class="event-explanation-row">
                        ...
                        <div class="event-explanation-row">
                            ...
                            <div class="event-explanation-content">先着30名</div>
                        </div>
                        <div class="event-explanation-row">
                    ...
                    <form action="{{route('oshmans.store')}}" method="post" >
                        @csrf
                        <div class="item-row">
