    ...
    <div class="pt-4 pb-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-2 mb-2" ><a href="{{ route('admin.try-on-2023') }}" class="list-href" >TRY ON キャンペーン のリストを確認する</a></div>
                <div class="p-2 mb-2" ><a href="{{ route('admin.go-murakami-2023') }}" class="list-href" >村上宗孝選手応援 キャンペーン のリストを確認する</a></div>
