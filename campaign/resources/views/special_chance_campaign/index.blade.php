        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <form action="{{ route('special-chance-campaign.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="itemRow">
                            ...
                            <div class="itemContent">
                                <div class='flex'>
                                    @foreach(App\Consts\Common::SEX_LIST as $key => $val)
                                        @if($key == App\Consts\Common::SEX_MEN)
                                            @continue
                                        @endif
                        ...
                        <div class='itemRow'>
                            <label for="birth_year" class="itemTitle">生年月日</label>
                            <div class="itemContent flex" style="align-items: center;justify-content: flex-start;" >
                                <div class="" style="margin-right: .5rem;" >
                                    <input type="text" style="width: 150px;" name="birth_year" id="birth_year" value="{{ old("birth_year") }}" placeholder="年">
                                </div>
                                /
                                <div class="" style="margin: 0 .5rem;" >
                                    <input type="text" style="width: 100px;" name="birth_month" value="{{ old("birth_month") }}" placeholder="月">
                                </div>
                                /
