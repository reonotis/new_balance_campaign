<x-TryOnFreshForm1080v13-layout>
    <x-slot name="head">
    ...
    <x-slot name="header">
        <h2 class="text-center font-bold leading-tight">
            Fresh Foam X 1080v13 <br class="brSp2">TRY ON CAMPAIGN <br class="brSp2">お申込フォーム
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <form action="{{route('try-on-2023-fresh-form-1080-v13.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="itemRow">
