<x-GolfTryOn2023-layout>
    <x-slot name="header">
        ...
        <h2 class="text-white text-center text-3xl font-bold leading-tight">
            GOLF TRY ON CAMPAIGN <br class="brSp2">お申込フォーム
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <form action="{{route('golf-try-on-2023.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="itemRow">
                        ...
                        <div class="itemRow">
                            <label for="reason_applying" class="itemTitle">返品動機</label>
                            <div class="itemContent">
                                <div class="flex w-full px-2">
                                    <textarea name="reason_applying" id="reason_applying"
                                              class="h-20">{{ old("reason_applying") }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="itemRow">
