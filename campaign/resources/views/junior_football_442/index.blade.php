<x-JuniorFootball442-layout>
    <x-slot name="header">
        <h2 class="text-center text-3xl font-bold leading-tight">
            Junior Football 442 品質保証キャンペーン <br class="brSp2">お申込フォーム
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <form action="{{route('442-junior-football.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="itemRow">
