<x-MinatoRunnersBase-layout>
    ...
    <x-slot name="support">
        <div class="support-content">
            <p>ニューバランス最新モデルシューズトライオン！<br>
                ＆アミノサウルスサプリセミナー
            </p>
            <p>日時：7/6（日）10:30-13:30（受付開始10:00）</p>
            <p>場所：スーパースポーツゼビオららぽーと名古屋みなとアクルス店/p>
            <p>内容：最新秋冬モデル試し履き＆サプリ講座</p>
            <p>参加費：無料</p>
        </div>
    </x-slot>
    <x-slot name="header">
    ...
    <div class="pt-4 pb-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg form-area">
                <div class="p-6 ">
                    ...
                    <form action="{{route('minato.store')}}" method="post" >
                        @csrf
                        <div class="item-row">
