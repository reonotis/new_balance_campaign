            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 ">
                    ...
                    <div class="overview-box">
                        myNB会員様向けShopping Night<br>
                        ゆっくりとショッピングを体験いただき、他のお客様より早くご来店いただける機会となっております。<br>
                        来場特典として、特別販売商品やケータリング、ささやかなお土産もご用意しておりますので、ぜひこの機会にご応募いただき、お気に入りニューバランスをご着用の上、特別なショッピングナイトにご参加ください。<br>
                        <br>
