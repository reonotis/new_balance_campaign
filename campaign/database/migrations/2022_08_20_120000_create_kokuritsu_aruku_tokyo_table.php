...
class CreateKokuritsuArukuTokyoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kokuritsu_aruku_tokyo', function (Blueprint $table) {
            ...
            $table->string('shoes_size')       ->nullable()->comment('希望するシューズのサイズ');
    ...
    {
        Schema::dropIfExists('kokuritsu_aruku_tokyo');
    }
}
