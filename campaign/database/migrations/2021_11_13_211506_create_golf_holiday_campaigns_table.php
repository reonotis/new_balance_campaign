...
class CreateGolfHolidayCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('golf_holiday_campaigns', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('golf_holiday_campaigns');
    }
}
